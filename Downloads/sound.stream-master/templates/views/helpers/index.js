...
module.exports = function () {
	...
	* */
    ...
    _helpers.echoLikeImage = function (hasLiked) {
		if (hasLiked == true) {
			return "/icons/Purple/like.svg";
		} else {
            return "/icons/White/like.svg";
        }
	};
    
    _helpers.likeImage = function (likes) {
		if (likes == 1) {
			return "/icons/Purple/like.svg";
		} else {
            return "/icons/White/like.svg";
    ...
    _helpers.echoDuration = function (duration) {
		return moment.duration(duration, 'milliseconds').format('m:ss', {trim: false})
	};
